...
#define DUMP_FILENAME_CORNERS_BASE   "mrgingham-1-corners"
...
#define SCALED_PROCESSED_IMAGE_FILENAME   "mrgingham-scaled-processed-level%d.png"
static const cv::Mat*
...
#define CHESS_RESPONSE_FILENAME                     "mrgingham-chess-response%s-level%d.png"
#define CHESS_RESPONSE_POSITIVE_FILENAME            "mrgingham-chess-response%s-level%d-positive.png"
static
...
{
    cv::Mat _image;
    std::cout << "image w,h:" << image_input.cols << "," << image_input.rows << std::endl;
    ...
    std::cout << "image w,h:" << w << "," << h << std::endl;
